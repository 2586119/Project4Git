<?php
	...
	class Film
	{
		...
		// methoden - functies ----------------------------
		// constructor
		public function __construct($filmId=NULL,  $filmNaam=NULL, $filmDatum=NULL, $filmTijdsduur=NULL, $filmGrene=NULL, $filmLeeftijd=NULL, $filmOmschrijving=NULL )
		{
			$this->filmId=$filmId;
